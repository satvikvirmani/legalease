...
import { Form, Input, Button, Link, Select, SelectItem } from "@heroui/react";
            ...
            <div className="col-span-2 lg:col-span-1 flex flex-col justify-between items-center">
                ...
                <Form className="w-full" validationBehavior="native" onSubmit={onSubmit}>
                    <div className="mx-auto">
                        <h1 className={`mb-2 text-center text-5xl font-light ${NotoSerif.className}`}>Welcome to LegalEase</h1>
                    ...
                    <div className="w-full max-w-xl flex flex-col items-center gap-8 mx-auto">
                        <div className="w-full grid grid-cols-2 grid-rows-2 gap-8">
                            ...
                            // placeholder="Choose your account type" labelPlacement="outside"
                        ...
                        <Button type="submit" isLoading={isLoading} variant="shadow" className="w-full bg-gray-900 text-gray-100">
                            Submit
                        </Button>
                    </div>
                </Form>
                <p className="text-base text-gray-600">Already have an account? <Link className="text-base font-normal text-gray-800 underline" href="/login" >Sign In</Link></p>
            </div>
